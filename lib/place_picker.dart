...
import 'package:google_maps_flutter_tutorial/google_map_place_picker.dart';
import 'package:google_maps_flutter_tutorial/model/search_model.dart';
import 'package:google_maps_flutter_tutorial/provider/place_provider.dart';
import 'package:google_maps_flutter_tutorial/screens/auto_complete_screen.dart';
import 'package:google_maps_flutter_tutorial/udid.dart';
import 'package:google_maps_webservice/places.dart';
import 'package:http/http.dart';
import 'package:provider/provider.dart';
import 'dart:io' show Platform;

import 'auto_complete_controller.dart';
...
class PlacePicker extends StatefulWidget {
  PlacePicker({
    ...
    this.hidePlaceDetailsWhenDraggingPin = true, this.backgroundColor,
  }) : super(key: key);

  final Function(GoogleMapController)? controllerCallBack;
...
class _PlacePickerState extends State<PlacePicker> {
  ...
  Future<PlaceProvider> _initPlaceProvider() async {
    ...
    final provider = PlaceProvider(packageConfig.getApiKey,
      widget.proxyBaseUrl,
      widget.httpClient,
      headers,
    );
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            return MultiProvider(
              ...
              child: widget.showOnlyMap?Container(
                child: Scaffold(
                  key: ValueKey<int>(provider.hashCode),
                  resizeToAvoidBottomInset: false,//widget.resizeToAvoidBottomInset,
                  // primary: ,
                  backgroundColor: Colors.white,
                  bottomNavigationBar: Container(height: 0,),
                  appBar: PreferredSize(key: appBarKey, child: Container(height: 0,),preferredSize: Size(0,0),),
                  body: Container(
    ...
    return Container(
      ...
      child: SafeArea(
        child: GoogleMapPlacePicker(
          ...
          appBarKey: appBarKey,
          showAddressDialog:widget.showAddressDialog,
          ...
          controllerCallBack: widget.controllerCallBack!,
...
class PackageConfig{
  ...
  get getApiKey => "AIzaSyBRvPgYBOxpkyEWXxxqErte182C245iy84";
}

...
import 'component/animated_pin.dart';
...
class GoogleMapPlacePicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        _buildPin(),
        _buildFloatingCard(),
        showAddressDialog?_buildMapIcons(context):Container(),
      ],
    );
  }
        ...
        builder: (_, data, __) {
          ...
          return ClipRRect(
              ...
              child:GoogleMap(
                  ...
                  mapType: data,
                  scrollGesturesEnabled: showAddressDialog,
                  ...
                  gestureRecognizers: showMapOnly?Set():(Set()..add(Factory<EagerGestureRecognizer>(() => EagerGestureRecognizer())))
              ));
        });
  }
  ...
  Widget _defaultPlaceWidgetBuilder(BuildContext context, PickResult? data, SearchingState state) {
    return FloatingCard(
        ...
        child: showAddressDialog?(state == SearchingState.Searching ? _buildLoadingIndicator() : _buildSelectionDetails(context, data!)):Container()
    );
  }
